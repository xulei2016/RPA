$(function(){
    ...
    function bindEvent(){
        ...
        let time = mydate.getFullYear()+'-'+month+'-'+mydate.getDate();
    ...
    function getSelectInfo(){
        ...
        selectInfo.reviewPeopName = selectObj.find('.search-group #name').val();
        selectInfo.from_openingTime = selectObj.find('.search-group #startTime').val();
        selectInfo.to_openingTime = selectObj.find('.search-group #endTime').val();
            ...
            success:function(json){
                if(json.code == 200){
                    ...
                    for(let i = 0; i < data.data.length;i++){
                        ...
                        +'<td>'+row.phone+'</td>'
                        +'<td>'+type+'</td>'
                        +'<td>'+row.videoPeopName+'</td>'
                        +'<td>'+row.checkPeopName+'</td>'
                        +'<td>'+row.reviewPeopName+'</td>'
