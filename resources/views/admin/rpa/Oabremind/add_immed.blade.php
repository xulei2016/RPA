            ...
            <form action="#" method="post" id="myForm" enctype="multipart/form-data" novalidate="novalidate">
                <table class="table table-striped table-hover table-bordered table-base">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" id="name" name="name" value="OABReminding" placeholder="任务名称" disabled></td>
                    </tr>
                    <tr>
...
<script src="{{URL::asset('/js/admin/rpa/Oabremind/add_immed.js')}}"></script>