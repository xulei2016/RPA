    ...
    <div class="list-title-panel middle-layer">
        <div class="auxiliary-tool">
            ...
            <a url="{{ URL('admin/rpa_jjr_image/add') }}" class="btn btn-primary btn-sm right" onclick="operation($(this))">添加任务</a>
            <a url="{{ URL('admin/rpa_jjr_image/immedtask') }}" class="btn btn-warning btn-sm right" onclick="operation($(this))">立即任务</a>
        </div>
    </div>
    ...
    <script type="text/javascript" src="{{URL::asset('/js/admin/rpa/JJRImg/index.js')}}"></script>