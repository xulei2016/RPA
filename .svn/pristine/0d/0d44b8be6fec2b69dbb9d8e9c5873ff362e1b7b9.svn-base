            ...
            <form action="#" method="post" id="myForm" enctype="multipart/form-data" novalidate="novalidate">
                <table class="table table-striped table-hover table-bordered table-base">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" id="name" name="name" value="CustomerGroupings" placeholder="任务名称" disabled></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="target_web">
                                ...
                                <input type="text" class="form-control" id="jsondate" name="jsondate" value="{{$info->data->date}}" placeholder="查询时间">
                            </div>
                        </td>
                        <td></td>
                    </tr>
