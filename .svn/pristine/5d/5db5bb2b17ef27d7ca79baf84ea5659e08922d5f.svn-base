...
$(function(){
        ...
        $("#container .inner-content .middle-layer .deletebatch").on('click', function(){
            ...
            if("" == ids){
	            ...
	            myConfirmModal("确定要批量删除资讯吗？",function(){
		            $.ajax({
		                url:"/admin/rpa_NewVideoHints/deleteAll",
		                type:"post",
		                data:{"ids":ids},
		                dataType:"json",
    ...
    function deleteOne(){
        ...
        myConfirmModal("确定要删除该资讯吗？",function(){
           $.ajax({
               url:"/admin/rpa_NewVideoHints/delete",
               type:"post",
               data:{"id":ids},
               dataType:"json",
               beforeSend:function(xhr){
    ...
    function render(pageIndex){
        $.ajax({
            type:'post',
            url:'/admin/rpa_NewVideoHints/rpa_list',
            ...
            success:function(json){
                if(json.code == 200){
                    ...
                    for(let i = 0; i < data.data.length;i++){
                        ...
                        +'<a class="btn btn-primary btn-sm edit" href="javascript:void(0);" data_id="'+id+'" url="/admin/rpa_NewVideoHints/edit/'+id+'" onclick="operation($(this))">修改</a> '
