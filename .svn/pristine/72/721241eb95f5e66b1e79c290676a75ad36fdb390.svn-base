<div class="list-title-panel middle-layer">
    ...
    <div class="auxiliary-tool">
        ...
        <a url="{{ URL('admin/role_manage/add_role') }}" class="btn btn-primary btn-sm right" onclick="operation($(this));">添加角色</a>
    </div>
</div>
...
<link href="{{URL::asset('/css/admin/admin/role/role.css')}}" rel="stylesheet">
    ...
    <script type="text/javascript" src="{{URL::asset('/js/admin/admin/role/role.js')}}"></script>