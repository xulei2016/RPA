    ...
    <div class="list-title-panel middle-layer">
        ...
        <div class="auxiliary-tool">
            ...
            <a href="javascript:;" class="btn btn-default btn-sm" onclick="refresh();"><i class="iconfont icon">&#xe6aa;</i></a>
    ...
    <script type="text/javascript" src="{{URL::asset('/js/admin/rpa/Statistics/log.js')}}"></script>