            ...
            <form action="#" method="post" id="myForm" enctype="multipart/form-data" novalidate="novalidate">
                <table class="table table-striped table-hover table-bordered table-base">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" id="name" name="name" value="MediatorVisit" placeholder="任务名称" disabled></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="target_web">
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="许亮" @if(in_Array('许亮',$info->data))checked @endif>许亮</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="陈瑛" @if(in_Array('陈瑛',$info->data))checked @endif>陈瑛</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="姚鑫" @if(in_Array('姚鑫',$info->data))checked @endif>姚鑫</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="李萌" @if(in_Array('李萌',$info->data))checked @endif>李萌</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="汪红" @if(in_Array('汪红',$info->data))checked @endif>汪红</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="余晓娟" @if(in_Array('余晓娟',$info->data))checked @endif>余晓娟</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="李园园" @if(in_Array('李园园',$info->data))checked @endif>李园园</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="汪俊俊" @if(in_Array('汪俊俊',$info->data))checked @endif>汪俊俊</label>
                                <label><input type="checkbox" class="select-single" name="jsondata[]" value="水佳状" @if(in_Array('水佳状',$info->data))checked @endif>水佳状</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
