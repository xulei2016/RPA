            ...
            <form action="#" method="post" id="myForm" enctype="multipart/form-data" novalidate="novalidate">
                <table class="table table-striped table-hover table-bordered table-base">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" id="name" name="name" value="" placeholder="品种名称"></td>
                    </tr>
                    <tr>
                        <td><label><span class="must-tag">*</span>最低资金</label></td>
                        <td><input type="text" class="form-control" id="exfund" name="exfund" value="" placeholder="最低资金余额（单位：元）"></td>
                    </tr>
                    <tr>
                        <td><label><span class="must-tag"></span>备注</label></td>
                        <td><input type="text" class="form-control" id="desc" name="desc" value="" placeholder="备注"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
...
<script src="{{URL::asset('/js/admin/rpa/Oabremind/varietyAdd.js')}}"></script>