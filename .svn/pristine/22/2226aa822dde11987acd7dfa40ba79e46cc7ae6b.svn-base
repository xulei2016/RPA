...
$(function(){
    ...
    function bindevent(){
        ...
        $("#container .inner-content .middle-layer .deletebatch").on('click', function(){
            ...
            if("" == ids){
	            ...
	            myConfirmModal("确定要批量删除数据吗？",function(){
		            $.ajax({
		                url:"/admin/rpa_jjr_distribution/deleteAll",
		                type:"post",
		                data:{"ids":ids},
		                dataType:"json",
    ...
    function deleteOne(){
        ...
        myConfirmModal("确定要删除该数据吗？",function(){
           $.ajax({
               url:"/admin/rpa_jjr_distribution/delete",
               type:"post",
               data:{"id":ids},
               dataType:"json",
               beforeSend:function(xhr){
    ...
    function render(pageIndex){
        $.ajax({
            type:'post',
            url:'/admin/rpa_jjr_distribution/rpa_list',
            ...
            success:function(json){
                if(json.code == 200){
                    ...
                    for(let i = 0; i < data.data.length;i++){
                        ...
                        +'<a class="btn btn-primary btn-sm edit" href="javascript:void(0);" data_id="'+id+'" url="/admin/rpa_jjr_distribution/edit/'+id+'" onclick="operation($(this))">修改</a> '
