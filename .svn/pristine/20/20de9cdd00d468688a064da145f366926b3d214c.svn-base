...
$(function(){
        ...
        $("#container .inner-content .middle-layer .deletebatch").on('click', function(){
            ...
            if("" == ids){
	            ...
	            myConfirmModal("确定要批量删除资讯吗？",function(){
		            $.ajax({
		                url:"/admin/rpa_questionnaire/deleteAll",
		                type:"post",
		                data:{"ids":ids},
		                dataType:"json",
    ...
    function deleteOne(){
        ...
        myConfirmModal("确定要删除该资讯吗？",function(){
           $.ajax({
               url:"/admin/rpa_questionnaire/delete",
               type:"post",
               data:{"id":ids},
               dataType:"json",
               beforeSend:function(xhr){
    ...
    function edit(){
        ...
        location.href="/admin/rpa_questionnaire/edit/"+id;
    }
    ...
    function render(pageIndex){
        $.ajax({
            type:'post',
            url:'/admin/rpa_questionnaire/rpa_list',
